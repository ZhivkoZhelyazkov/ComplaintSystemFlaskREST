...
class ComplaintManager:
    ...
    def issue_transaction(amount, full_name, iban, complaint_id):
        ...
        transfer_data = {
            ...
            "target_account_id": str(custom_id),
            "amount": amount,
    ...
    def create(complaint_data, complainer):
        """
        This function decodes the base64 encoded string from the client
        and upload the photo to s3 AWS service.
        Flushes the database with the newly created complaint and
        issues a new payment transaction in Pending state in the payment provider.
        """
